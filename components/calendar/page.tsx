...
//             <h1 className='font-bold test-2xl text-gray-700'>Calendar</h1>
//         </nav>
...
interface CalendarProps {
  ...
  setTimetableEvents: React.Dispatch<React.SetStateAction<Event[]>>;
}

const Calendar: React.FC<CalendarProps> = ({ timetableEvents, setTimetableEvents }) => {
  ...
  function addEvent(data: DropArg) {
    ...
    setTimetableEvents([...timetableEvents, event]);
  }
